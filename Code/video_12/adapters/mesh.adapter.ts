...
export class MeshAdapter {
    ...
    constructor({ meshWallet = null!, ownerAddress }: { meshWallet: MeshWallet, ownerAddress?: string }) {
        ...
        this.spendCompileCode = this.readValidator(plutus as Plutus, title.tipjar);

        this.spendScriptCbor = applyParamsToScript(this.spendCompileCode, [ deserializeAddress(ownerAddress as string).pubKeyHash,Number(process.env.MIN_TIP_AMOUNT)  ]);
